...
namespace ITI.MVC.Project.Test2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(GeneralViewModel model, string returnUrl)
        {
            if (!ModelState.IsValid)
            {
               model.HVM.categories = context.categories.ToList();
               model.HVM.subcategories = context.subcategories.ToList();
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(GeneralViewModel model)
        {
            if (ModelState.IsValid)
            {
